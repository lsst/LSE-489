...
Define an implementation plan and timeline for the proposed strategy.
} 
\item { 
Based on required input from each subsystem, SIT-COM and the Project Office, the working group shall provide an assessment of the resources needed to meet the objectives defined by items 2, 3 and 4.
...
This includes personnel, contracted services (if necessary) and system procurements.
 ...
 \item{
 The working group shall provide a risk assessment for not meeting requirements for each tier in the document package.
 }
\end{enumerate}
